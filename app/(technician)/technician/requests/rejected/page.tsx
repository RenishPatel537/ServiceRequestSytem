    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col gap-1">
                <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Rejected</h2>
                <p className="text-sm text-gray-500 font-medium">Service requests that were rejected by authorities.</p>
            </div>
            ...
            {loading ? (
                ...
                <RequestTable requests={requests} emptyMessage="No rejected requests found." />
            )}
        </div>
    );
}
