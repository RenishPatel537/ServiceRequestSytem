    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col gap-1">
                <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Pending Requests</h2>
                <p className="text-sm text-gray-500 font-medium">New requests awaiting your attention.</p>
            </div>
            ...
            {loading ? (
                ...
                <RequestTable requests={requests} emptyMessage="You have no pending requests." />
            )}
        </div>
    );
}
